...
def check_password():
    ...
    if "password_correct" not in st.session_state or not st.session_state["password_correct"]:
        ...
        # Exibe a logo na pasta do projeto
...
if st.sidebar.button("Analisar Risco e Salvar no Banco"):
    if modelo:
        try:
            ...
            # Probabilidade de acidente (classe 1) e multiplicamos por 100
            ...
            try:
                ...
                # Query de Inserção na tabela tb_historico_risco (Atenção a tabela deve estar criada no banco)
...
if st.button("Ultimos Registros"):
    try:
        ...
        if linhas:
            # Transformando os dados em uma tabela Pandas para exibir no Streamlit
